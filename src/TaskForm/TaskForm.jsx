...
const TaskForm = ({user, handleAddTask, onClose}) => {
    ...
    return (
        <div className='fixed inset-0 flex items-center justify-center bg-black bg-opacity-50'>
            <div className='bg-white shadow-lg p-5 rounded-md w-96'>
                <h2 className='text-3xl text-blue-500'>Add a New Task</h2>
                <form onSubmit={handleSubmit}>
                    ...
                    <div className='flex items-center gap-5'>
                        ...
                        <button type='submit' disabled={loading} className="px-4 py-2 bg-blue-500 text-white rounded">{loading ? "Adding..." : "Add Task"}</button>
                    </div>
                </form>
            </div>
        </div>
